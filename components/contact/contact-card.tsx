            ...
            <div className="relative grid gap-8 p-6 sm:gap-10 sm:p-7 md:grid-cols-[1.2fr_1fr] md:items-stretch md:gap-6 md:p-6">
              <div className="flex flex-col gap-5">
                ...
                <p className="mb-6 max-w-[29ch] text-[18px] leading-[1.4] tracking-tight text-foreground/65 sm:text-[22px]">
                  ...
                  ideas, or opportunities to be part of your visions. Just
                  reach out!
                </p>
                <ContactCardCtas />
              </div>
              ...
              <div className="border-foreground/8 flex flex-col items-center justify-center gap-6 rounded-[1.1rem] border bg-background p-6 sm:p-8">
                <div className="flex items-center gap-3 opacity-75">
                  <SocialIcon
                    href="https://mail.google.com/mail/?view=cm&fs=1&to=johnpeterndikubwi@gmail.com"
                    label="Email"
                    lucideIcon={Mail}
                  />
                  <SocialIcon
                    href="https://www.linkedin.com/in/john-peter-muberuka-ndikubwimana-66b414384/"
                    label="LinkedIn"
                    lucideIcon={Linkedin}
                  />
                  <SocialIcon
                    href="https://wa.me/250786491056"
                    label="WhatsApp"
                    customIcon={
...
// Lucide doesn't ship a WhatsApp glyph, so this is a small self-contained
// inline SVG — no external asset or extra dependency needed.
